...
func gather_hair_color(n):
	if n == 1:
		ClassVariables.playerHairColor = %haircolor1.text
		return ClassVariables.playerHairColor
	elif n == 2:
		ClassVariables.playerHairColor = %haircolor2.text
		return ClassVariables.playerHairColor
	elif n == 3:
		ClassVariables.playerHairColor = %haircolor3.text
		return ClassVariables.playerHairColor
	elif n == 4:
		ClassVariables.playerHairColor = %haircolor4.text
		return ClassVariables.playerHairColor
	elif n == 5:
		ClassVariables.playerHairColor = %haircolor5.text
		return ClassVariables.playerHairColor
	elif n == 6:
		ClassVariables.playerHairColor = %haircolor6.text
		return ClassVariables.playerHairColor
	elif n == 7:
		ClassVariables.playerHairColor = %haircolor7.text
		return ClassVariables.playerHairColor
	elif n == 8:
		ClassVariables.playerHairColor = %haircolor8.text
		return ClassVariables.playerHairColor
...
func _on_haircolor_1_pressed() -> void:
	...
	gather_hair_color(1)
	print(ClassVariables.playerHairColor)
